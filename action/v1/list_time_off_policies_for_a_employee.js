module.exports = {
  ...
  name: "list_time_off_policies_for_a_employee",

  title: "List Time Off Policies For A Employee",
  ...
  input:{
    ...
    properties: {
 eid: {
        title: "Enter Emplyee ID",
        displayTitle: "Enter Emplyee ID",
        description: "Emplyee ID",
        type: "string",
        minLength: 1,
        propertyOrder: 1
      }
  ...
  execute: function(input, output){
    ...
    passwor = "x",
    url = "https://api.bamboohr.com/api/gateway.php/"+input.auth.subdom+"/v1/employees/"+input.eid+"/time_off/policies";
