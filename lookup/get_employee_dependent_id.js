module.exports = {
  name: "get_employee_dependent_id",

  label: "Get Employee Dependent Id",
  ...
  execute: function(input, options, output) {
    ...
    self
      ...
      .then(res => {
        ...
        if (
          res &&
          Array.isArray(res["Employee Dependents"]) &&
          res["Employee Dependents"].length
        ) {
          res["Employee Dependents"].forEach(dependent => {
            if (dependent) {
              arr.push({
                id: String(dependent.id),
                value: String(dependent.firstName)
              });
            }
          });
